...
module.exports = {
  build: {
    ...
    nw: {
      ...
      manifest: ['name', 'appName', 'version', 'description', 'author', { main: 'index.html' }, 'manifestUrl', 'packages', 'window', 'nodejs', 'js-flags', 'node-remote', 'dependencies'],
      ...
      setup: {
        ...
        appPublisher: 'DCE, Inc.',
        appURL: 'dce.cn',
        appId: '{{440BB043-0703-43FA-AA1F-5D9259096FEE}}',
      ...
      upgrade: {
        ...
        publicPath: 'http://atcdn.enry.cn/dce-fe/',
        files: [curReleasesPath]
      }
    }
  },
