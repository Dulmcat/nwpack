...
Datafeeds.UDFCompatibleDatafeed.prototype._initialize = function() {
	...
	// 	});
	this._send(this._datafeedURL + '/rest/index.php',{
		c: 'conf',
		a: 'conf'
	})
	.done(function(response) {
...
Datafeeds.UDFCompatibleDatafeed.prototype.resolveSymbol = function(symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
	...
	if (!this._configuration.supports_group_request) {
		setTimeout(function () {
			var response = {"exchange-traded":"","exchange-listed":"","timezone":"Asia/Shanghai","minmov":1,"minmov2":0,"pointvalue":1,"session":"24x7","has_intraday":true,"has_no_volume":false,"description":"","type":"stock", "pricescale":100,"ticker":"AAPL"}
			var data = parseJSONorNot(response);
			if (data.s && data.s !== 'ok') {
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function(symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
	...
	this._send(this._datafeedURL + ':8017/kline/index3.php', {
		price_id: code,
		type: resolution,
		from: rangeStartDate,
		to: rangeEndDate,
		few: Date.parse(new Date()) / 1000
	})
	.done(function(response) {
...
Datafeeds.DataPulseUpdater = function(datafeed, updateFrequency) {
	...
	var update = function() {
		...
		for (var listenerGUID in that._subscribers) {
			...
			var datesRangeLeft = datesRangeRight - that.periodLengthSeconds(resolution, 1);
